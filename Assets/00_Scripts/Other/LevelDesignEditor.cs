...
public class LevelDesignEditor : Editor
{
    ...
    private void DrawGraph(LevelData data, StageData s_Data)
    {
        ...
        GetColorGUI("MAXEXP", StringMethod.ToCurrencyString(Utils.CalculatedValue(data.B_MAXEXP, design.currentLevel, data.C_MAXEXP)), Color.white);
        ...
        GetColorGUI("M_ATK", StringMethod.ToCurrencyString(Utils.CalculatedValue(s_Data.B_ATK, design.currentStage, s_Data.M_ATK)), Color.green);
        GetColorGUI("M_HP", StringMethod.ToCurrencyString(Utils.CalculatedValue(s_Data.B_HP, design.currentStage, s_Data.M_HP)), Color.red);
        GetColorGUI("M_MONEY", StringMethod.ToCurrencyString(Utils.CalculatedValue(s_Data.B_MONEY, design.currentStage, s_Data.M_MONEY)), Color.blue);
    }
